...
var controller_movie_player = movie_player.controller('controller_movie_player', ['$scope', '$routeParams',function ($scope, $routeParams) {
		...
		$scope.pause_play = function () {
		  g_player.pause();
		};

		$scope.stop_play = function () {
		  g_player.stop();
		  g_player = null;
			player_running = 0;
